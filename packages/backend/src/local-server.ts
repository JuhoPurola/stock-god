...
function toLambdaEvent(req: express.Request): any {
  return {
...
function fromLambdaResult(res: express.Response, result: any) {
  if (result.headers) {
...
function wrapHandler(handler: (event: any) => Promise<any>) {
