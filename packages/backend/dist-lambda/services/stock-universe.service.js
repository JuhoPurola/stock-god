...
export class StockUniverseService {
     ...
     */
    async populateCuratedSmallCaps() {
     ...
     */
    async fetchSmallCapStocksFromFMP() {
        ...
        const usStocks = stocks.filter((stock) => {
            return (stock.isActivelyTrading &&
                !stock.isEtf &&
                stock.country === 'US' &&
     ...
     * - Nano cap: < $50M
     */
    async getStocksByMarketCap(minMarketCap, maxMarketCap, limit = 1000) {
...
//# sourceMappingURL=stock-universe.service.js.map