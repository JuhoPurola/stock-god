...
export class PriceDataService {
     ...
     */
    async loadHistoricalPrices(symbol, outputSize = 'compact') {
        ...
        try {
            ...
            data.forEach((price, index) => {
                ...
                values.push(symbol, price.date, price.open, price.high, price.low, price.close, price.volume);
            });
     ...
     */
    async loadHistoricalPricesFromFMP(symbol, fromDate, toDate) {
     ...
     */
    async loadBulkHistoricalPricesFromFMP(symbols, fromDate, toDate) {
     ...
     */
    async loadBulkHistoricalPrices(symbols, outputSize = 'compact') {
     ...
     */
    async getSymbolsNeedingUpdate(maxAge = 7) {
     ...
     */
    async generateSamplePrices(symbol, days = 365) {
     ...
     */
    async generateSamplePricesForDateRange(symbol, startDate, endDate) {
