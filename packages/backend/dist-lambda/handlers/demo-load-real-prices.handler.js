...
export async function handler(event) {
    try {
        ...
        const outputSize = (event.queryStringParameters?.outputSize || 'compact');
      ...
      `, [smallCapUniverse]);
        ...
        const results = await priceDataService.loadBulkHistoricalPrices(batchToLoad, outputSize);
...
//# sourceMappingURL=demo-load-real-prices.handler.js.map