...
export async function handler(event) {
    try {
        ...
        const initialCash = parseInt(event.queryStringParameters?.initialCash || '100000');
        ...
        const performance = await backtestService.runBacktest(backtestId, backtestConfig, alphaStrategy, { skipDatabaseRecording: true });
...
//# sourceMappingURL=demo-alpha-backtest.handler.js.map