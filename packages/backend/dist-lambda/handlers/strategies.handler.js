...
import { createStrategySchema, updateStrategySchema, } from '@stock-picker/shared';
 ...
 */
export async function listStrategies(event) {
    try {
 ...
 * Get strategy by ID
 */
export async function getStrategy(event) {
    try {
 ...
 * Create strategy
 */
export async function createStrategy(event) {
    try {
 ...
 * Update strategy
 */
export async function updateStrategy(event) {
    try {
        const strategyId = getPathParam(event, 'id');
 ...
 * Delete strategy
 */
export async function deleteStrategy(event) {
    try {
        const strategyId = getPathParam(event, 'id');
 ...
 */
export async function toggleStrategy(event) {
    try {
        const strategyId = getPathParam(event, 'id');
 ...
 */
export async function testStrategy(event) {
    try {
        const strategyId = getPathParam(event, 'id');
 ...
 */
export async function executeStrategy(event) {
    try {
        const strategyId = getPathParam(event, 'id');
        const body = JSON.parse(event.body || '{}');
        ...
        if (executeTrades) {
            ...
            trades = await tradingService.executeSignals(strategy.portfolioId, strategyId, signals);
        }
...
//# sourceMappingURL=strategies.handler.js.map