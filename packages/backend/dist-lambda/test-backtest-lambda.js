...
export async function handler(event) {
    try {
       ...
       ON CONFLICT (id) DO NOTHING`, ['test-user-1', 'test@example.com', 'Test User']);
        await query(`INSERT INTO portfolios (id, user_id, name, description, cash_balance, trading_mode, created_at, updated_at)
       VALUES ($1, $2, $3, $4, $5, $6, NOW(), NOW())
       ON CONFLICT (id) DO NOTHING`, ['test-portfolio-1', 'test-user-1', 'Test Portfolio', 'For testing', 100000, 'paper']);
       ...
       ON CONFLICT (id) DO UPDATE SET
        ...
        const performance = await backtestService.runBacktest('test-backtest-direct', backtestConfig, strategy);
...
//# sourceMappingURL=test-backtest-lambda.js.map